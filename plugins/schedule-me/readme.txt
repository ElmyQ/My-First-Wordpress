=== Schedule me ===
Contributors: muhammadfahad,noumantayyab
Tags: schedule, meeting, call, calendar
Tested up to: 4.7.3
...
4. Then enable the Schedule button by just checking the enable/disable checkbox and the schedule a call button will start appearing on the lower right corner of the site.
...
1. Schedule a call button on the site after plugin activation. 
2. Add new schedule manually in the wordpress admin panel.
3. Plugin's settings to activate and email address input.
4. Calendar view of the meeting schedules.
5. Schedule form after clicking on the schedule a call button and side bar button added with short code.
